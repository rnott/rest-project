...
public class ModelRequestTest extends ValidatorBasedTest {
    ...
    Object [][] valid() {
        return new Object [][] {
            { 
              "testModel",
              "Test Model",
              ModelRequest.ModelType.QUALIFIED,
              ModelRequest.RebalanceFrequency.ANNUAL,
              10,
              5,
    ...
    public void validation( String name, String description,
            ModelRequest.ModelType modelType, ModelRequest.RebalanceFrequency rebalanceFrequency,
            ...
            List<AssetAllocation> assetAllocations )
    {
        ...
        Set<ConstraintViolation<ModelRequest>> violations = factory.getValidator().validate( model );
